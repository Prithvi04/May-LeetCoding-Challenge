...
//The idea is based on graph colouring, Use BFS or DFS and colour the adjacents with different colours.
//If one two adjacents are same colour then Bipartition is not possible.